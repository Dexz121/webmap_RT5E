...
interface UsuarioMenuProps {
  onNavigate: (
    screen: 'menu' | 'asignarViajePaqueteria' | 'asignarViaje' |
      'usuarios' | 'usuariosConductor' | 'vehiculos' | 'viajes' | 'tarifa'
  ) => void;
}

const botones = [
  { label: 'Asignar viaje', screen: 'asignarViajes', icon: require('../assets/images/viajes-1.png') },
  { label: 'Pasajeros', screen: 'usuarios', icon: require('../assets/images/user.png') },
  { label: 'Conductor', screen: 'usuariosConductor', icon: require('../assets/images/taxi-1.png') },
