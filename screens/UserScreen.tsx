...
const UsuarioMenu = () => {
  ...
  return (
    <View className="h-full w-full bg-transparent p-4 rounded-3xl overflow-hidden">
        ...
        <View className="mt-12 px-8">
          {(role === 'pasajero' || role === 'admin') && (
            <View className="flex-row justify-between gap-4 mb-6">
              <TouchableOpacity
                className="w-40 h-40  rounded-xl shadow-md flex justify-center items-center"
                onPress={() =>
                  router.push({
                    pathname: '/usuario_seleccion_destino',
                    params: { tipo: 'viaje' },
                  })
                }
              >
          ...
          {(role === 'conductor' || role === 'admin') && (
            <View className="flex-row justify-between gap-4 mb-6">
              ...
              >
                <Image
                  source={require('../assets/images/user-in.png')}
                  className="w-20 h-20"
                />
                <Text className="text-black font-semibold mt-2 text-center">
                  Datos de usuario
              ...
              >
                <Image
                  source={require('../assets/images/pagos.png')}
                  className="w-20 h-20"
                />
                <Text className="text-black font-semibold mt-2 text-center">
                  Ganancias
