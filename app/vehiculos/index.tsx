          ...
          <View className="flex-row justify-between mb-4">
            ...
            <View className="flex-row space-x-2">
              <TouchableOpacity
                ...
                onPress={() => router.push('/vehiculos/agregar')}
              >
              ...
              {vehiculoSeleccionado && (
                <TouchableOpacity
                  ...
                  onPress={() => router.push(`/vehiculos/editar/${vehiculoSeleccionado}`)}
                >
                  <Text className="text-white font-semibold text-sm">
                    Editar Vehículo
                  </Text>
                ...
                return (
                  <TouchableOpacity
                    ...
                    className={`flex-row border-b border-gray-200 py-2 items-center ${
                      estaSeleccionado ? 'bg-yellow-100' : ''
                    }`}
                  >
                    ...
                    <TouchableOpacity
                      className={`w-32 px-2 py-1 rounded-full ${
